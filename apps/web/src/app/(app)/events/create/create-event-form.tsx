...
import { EventQualityPanel } from "~/components/events/event-quality-panel";
...
import { getEventQualityReport } from "~/lib/event-quality";
...
export function CreateEventForm({ locations, userOrgs }: CreateEventFormProps) {
  ...
  const resolvedOrgId = selectedOrgId === PERSONAL_ORG_VALUE ? undefined : selectedOrgId;
  const qualityReport = getEventQualityReport({
    title,
    description,
    tags,
    flyerUrl,
    externalLink: externalLink.trim() || null,
    endDatetime: showEndDate && endDate ? endDate : null,
    orgId: resolvedOrgId,
    isPublic,
  });
    ...
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="order-1 xl:order-2">
        <div className="xl:sticky xl:top-24">
          <EventQualityPanel mode="create" report={qualityReport} />
        </div>
      </div>
    </div>
  );
